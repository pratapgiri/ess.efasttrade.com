        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <Card className="mb-8">
            <CardContent className="p-6">
              <div>
                <h1 style={{ color: '#191083' }} className="text-2xl font-bold text-gray-900 mb-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <Card>
              <CardHeader>
                <CardTitle style={{ color: '#191083' }} className="flex items-center gap-2 text-lg font-semibold">
            ...
            <Card>
              <CardHeader>
                <CardTitle style={{ color: '#191083' }} className="text-lg font-semibold">{t('Professional Information')}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
            ...
            <Card>
              <CardHeader>
                <CardTitle style={{ color: '#191083' }} className="text-lg font-semibold">{t('Additional Information')}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                {visibilityFields && visibilityFields.includes('cover_letter') && (
                  <div>
            ...
            <Card>
              <CardHeader>
                <CardTitle style={{ color: '#191083' }} className="text-lg font-semibold">{t('Additional Questions')}</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">

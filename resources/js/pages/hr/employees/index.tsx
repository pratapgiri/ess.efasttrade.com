...
export default function Employees() {
  ...
  const handleToggleStatus = (employee: any) => {
    const userStatus = employee.status;
    const empStatus = employee.employee?.employee_status;
    const isCurrentlyActive = userStatus === 'active' && empStatus === 'active';
                  ...
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="w-48 z-50" sideOffset={5}>
                        ...
                        {hasPermission(permissions, 'edit-employees') && (() => {
                          const isActive = employee.status === 'active' && employee.employee?.employee_status === 'active';
                          return (

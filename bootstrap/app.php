    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        $middleware->alias([
           ...
           // 'role_or_permission' => \Spatie\Permission\Middleware\RoleOrPermissionMiddleware::class,
            'role' => \App\Http\Middleware\SuperAdminRoleMiddleware::class,
            'permission' => \App\Http\Middleware\SuperAdminPermissionMiddleware::class,
            'role_or_permission' => \App\Http\Middleware\SuperAdminRoleOrPermissionMiddleware::class,
